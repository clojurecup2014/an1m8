...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_12650 = (0);while(true){
if((i_12650 < arr.length))
{(arr[i_12650] = null);
{
var G__12651 = (i_12650 + (1));
i_12650 = G__12651;
continue;
}
} else
...
{var i_12657 = (self__.level + (1));while(true){
if((i_12657 <= (new_level + (1))))
{(update[i_12657] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12659 = (0);while(true){
if((i_12659 <= self__.level))
{var links_12660 = (update[i_12659]).forward;if(((links_12660[i_12659]) === x__$1))
{(links_12660[i_12659] = (x__$1.forward[i_12659]));
{
var G__12661 = (i_12659 + (1));
i_12659 = G__12661;
continue;
}
} else
{{
var G__12662 = (i_12659 + (1));
i_12659 = G__12662;
continue;
}
}
