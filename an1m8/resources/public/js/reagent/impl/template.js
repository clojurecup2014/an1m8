...
{return (function() { 
var G__6561__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__3626__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__3626__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__6564 = res;(G__6564[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__6564;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__6565){var vec__6567 = p__6565;var id = cljs.core.nth.call(null,vec__6567,(0),null);var class$ = cljs.core.nth.call(null,vec__6567,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_6568 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_6568 === "key")))
{(o[pname_6568] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__6571 = jsprops;(G__6571["defaultValue"] = value);
(G__6571["value"] = null);
(G__6571["onChange"] = ((function (G__6571,on_change,value){
return (function (p1__6569_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__6569_SHARP_);
});})(G__6571,on_change,value))
);
return G__6571;
}
});
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__6577 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__6577,(0),null);var id = cljs.core.nth.call(null,vec__6577,(1),null);var class$ = cljs.core.nth.call(null,vec__6577,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__3626__auto__ = id;if(cljs.core.truth_(or__3626__auto__))
{return or__3626__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__6579 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__6579,(0),null);var id_class = cljs.core.nth.call(null,vec__6579,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj6583 = {};(obj6583[reagent.impl.util.cljs_argv] = v);
(obj6583[reagent.impl.util.cljs_level] = level);
return obj6583;
})();var k_6584 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__6585 = (((k_6584 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_6584);if((k_SINGLEQUOTE__6585 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__6585);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4495__auto___6586 = a.length;var i_6587 = (0);while(true){
if((i_6587 < n__4495__auto___6586))
{(a[i_6587] = reagent.impl.template.as_component.call(null,(a[i_6587]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4495__auto___6589 = a.length;var i_6590 = (0);while(true){
if((i_6590 < n__4495__auto___6589))
{if((i_6590 >= first_child))
{(a[i_6590] = reagent.impl.template.as_component.call(null,(a[i_6590]),level));
} else
{}
{
