...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12743 = (0);while(true){
var m_12744 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12744 == null))
{} else
{m_12744.call(null);
if((count_12743 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12745 = (count_12743 + (1));
count_12743 = G__12745;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3614__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3614__auto__)
