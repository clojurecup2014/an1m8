...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12749 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12749 = (function (val,box,meta12750){
this.val = val;
this.box = box;
this.meta12750 = meta12750;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t12749.cljs$lang$type = true;
cljs.core.async.impl.channels.t12749.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12749";
cljs.core.async.impl.channels.t12749.cljs$lang$ctorPrWriter = (function (this__4202__auto__,writer__4203__auto__,opt__4204__auto__){return cljs.core._write.call(null,writer__4203__auto__,"cljs.core.async.impl.channels/t12749");
});
cljs.core.async.impl.channels.t12749.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12749.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12751){var self__ = this;
var _12751__$1 = this;return self__.meta12750;
});
cljs.core.async.impl.channels.t12749.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12751,meta12750__$1){var self__ = this;
var _12751__$1 = this;return (new cljs.core.async.impl.channels.t12749(self__.val,self__.box,meta12750__$1));
});
cljs.core.async.impl.channels.__GT_t12749 = (function __GT_t12749(val__$1,box__$1,meta12750){return (new cljs.core.async.impl.channels.t12749(val__$1,box__$1,meta12750));
});
}
return (new cljs.core.async.impl.channels.t12749(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_12752 = self__.takes.pop();if((taker_12752 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12752))
{var take_cb_12753 = cljs.core.async.impl.protocols.commit.call(null,taker_12752);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12753,taker_12752,this$__$1){
return (function (){return take_cb_12753.call(null,null);
});})(take_cb_12753,taker_12752,this$__$1))
);
} else
{}
{
...
var putter_12754 = self__.puts.pop();if(!((putter_12754 == null)))
{var put_handler_12755 = putter_12754.handler;var val_12756 = putter_12754.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_12755))
{var put_cb_12757 = cljs.core.async.impl.protocols.commit.call(null,put_handler_12755);var __12758__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_12757,__12758__$1,put_handler_12755,val_12756,putter_12754,_,retval,this$__$1){
return (function (){return put_cb_12757.call(null,true);
});})(put_cb_12757,__12758__$1,put_handler_12755,val_12756,putter_12754,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_12756);
} else
{{
continue;
}
